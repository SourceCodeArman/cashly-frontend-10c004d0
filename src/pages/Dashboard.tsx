        ...
        <Card className="border-border shadow-soft hover:shadow-md transition-shadow">
          ...
          <CardContent>
            <div className="text-2xl font-bold text-destructive">
              {formatCurrency(data?.total_spending || 0)}
            </div>
          </CardContent>
        </Card>
      </div>
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    {data?.savings_goals_summary.active_goals_count || 0} active goals
                  </p>
                </div>
              </div>
              <div className="text-right">
                <p className="text-xl font-bold text-accent">
                  {formatCurrency(data?.savings_goals_summary.total_saved || 0)}
                </p>
                <p className="text-sm text-muted-foreground">
                  of {formatCurrency(data?.savings_goals_summary.total_target || 0)}
                </p>
              </div>
            </div>
          </CardContent>
